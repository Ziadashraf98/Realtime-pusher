...
<body>
                                    ...
                                    <a href="">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <h6 class="media-heading text-right ">{{$notification->user->name}}</h6>
                                                <h6 class="media-heading text-right ">{{$notification->post->content}}</h6>
                                                    
                                                <p class="notification-text font-small-3 text-muted text-right">{{$notification->comment->comment}}</p>
                                                <small style="direction: ltr;">
                                                    <p class=" text-muted text-right"
                                                    style="direction: ltr;">{{date('d/m/y | h:i A', strtotime($notification->created_at))}}
                                                </p>
                                                <br>
    ...
    <script>
        ...
        var pusher = new Pusher('ab311d48732e4a2bdac5', {
        cluster: 'mt1'
        });
    </script>
    <script src="{{asset('Js/pusherNotifications.js')}}">
